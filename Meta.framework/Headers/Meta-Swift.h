...
typedef SWIFT_ENUM(NSInteger, MetaExperienceCloseReason, closed) {
...
typedef SWIFT_ENUM(NSInteger, MetaLogLevel, closed) {
...
typedef SWIFT_ENUM(NSInteger, MetaRenderingEngine, closed) {
